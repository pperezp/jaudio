...
public class HoraAudio {
    ...
    private static String RUTA_AUDIOS = "audios" + File.separator;

    public static void setCarpetaAudios(File carpeta) {
        RUTA_AUDIOS = carpeta.getPath() + File.separator;
    }
    
    public static void decirHora(int hora, int minuto) throws LineUnavailableException, IOException, UnsupportedAudioFileException {
...
//            sonar(fpp, fmin, fhora, fjorn).start();
    ...
    public static void decirHora() throws LineUnavailableException, IOException, UnsupportedAudioFileException {
        decirHora(Integer.parseInt(Hora.getHora()), Integer.parseInt(Hora.getMinuto()));
    }
